      ...
      <main>
        ...
        <div className={styles.festival}>
          ...
          <div className="sharebar">
            <FacebookShareButton url={'https://imdbplus-teal.vercel.app/'} quote={'Bring the festivals back to life/live'} hashtag={'#festivals'}><FacebookIcon size={32} round /> </FacebookShareButton>
          </div>
